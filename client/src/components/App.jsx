      ...
      <div>
        <Router>
            <div>
                ...
                <Route path="/createTrip" render={(props) => (
                    !this.state.loggedInUser ? (
                      <Redirect to="/login"/>
                    ) : (
                      <CreateTrip loggedInUser = {this.state.loggedInUser} {...props} />
                    )
                )} />
                <Route path="/contributeTrip" render={(props) => (
                  !this.state.loggedInUser ? (
                    <Redirect to="/login"/>
                  ) : (
                    <ContributeTrip loggedInUser = {this.state.loggedInUser} {...props} />
                  )
              )} />
            </div>
        </Router>
